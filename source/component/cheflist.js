        ...
        <View style={{marginVertical:16}}>
            ...
            <FlatList
                ...
                renderItem={({item}) =>{
                    ...
                    return<View style={{width:175, padding:8, marginHorizontal:8, backgroundColor:'#f9f9fb', borderRadius:10}}>
                        <Image
                        ...
                        <Text numberOfLines={1} style={{ fontFamily:'book', fontSize:16, alignSelf:'center'}}>{item.city}</Text>
